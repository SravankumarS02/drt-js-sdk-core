...
describe("test token management transactions factory", () => {
    ...
    it("should create 'Transaction' for registering and setting roles", async () => {
        ...
        assert.deepEqual(
            ...
            Address.newFromBech32("drt1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls6prdez"),
        );
    ...
    it("should create 'Transaction' for registering metaDcdt", async () => {
        const transaction = await tokenManagementFactory.createTransactionForRegisteringMetaDCDT(frank.address, {
            tokenName: "FRANK",
            tokenTicker: "FRANK",
            numDecimals: 10n,
            canFreeze: true,
